...
product_title <- "Wind speed of gust"
product_units <- "(m/s at 10m)"
ELEVATION <- 10
layer_title <-"wind_speed_of_gust"
wms_url <- "https://thredds.met.no/thredds/wms/aromearcticlatest/arome_arctic_pp_2_5km_latest.nc?"
wms_layer <- "wind_speed_of_gust"
